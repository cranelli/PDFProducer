...
void RunModule::initialize(){
  
  tree =(TTree*)infile->Get((inRootFileLoc+":ggNtuplizer/EventTree").c_str());
  out_tree = new TTree("out_tree", "Contains Parton Distribution calculations for different PDF Sets");

  // Pull Original PDF Information
  TBranch *b_pdf;
